   ...
   */
   ...
   public static void main (String [] args)
   {
     ...
     /* estabelecimento do servico */
      ...
      DepartureTerminalInter = new DepartureTerminalInterface (DepartureTerminal);        // activação do interface com o serviço
     ...
     /* processamento de pedidos */
      ...
      while (waitConnection)
        ...
        { sconi = scon.accept ();                          // entrada em processo de escuta
          cliProxy = new DepartureTerminalProxy (sconi, DepartureTerminalInter);  // lançamento do agente prestador do serviço
          cliProxy.start ();
        }
